...
//        };
 ...
 public:
    ...
    PRB2CompactQtree(std::vector<Point<uint> > &points, BitSequenceBuilder *bs, BitSequenceBuilder *bb,BitSequenceBuilder *bc,int k1=2, int k2=2, int F=1, int max_level_k1=0, int max_levels_ki=0);
