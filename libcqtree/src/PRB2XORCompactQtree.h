/*
 * PRB2XORCompactQtree.h
 *
 *  Created on: Apr 15, 2014
 *      Author: diegocaro
 */

#ifndef PRB2XORCOMPACTQTREE_H_
#define PRB2XORCOMPACTQTREE_H_
...
//template<typename T>
class PRB2XORCompactQtree:public CompactQtree {
  struct Node {
      size_t lo, hi;
      int level;
  };
...
//    struct Less {
//            Less(const PRB2XORCompactQtree& cl) : c(cl) {
////                printf("depth: %d\n",c.depth_);
...
//        };
 ...
 public:
    ...
    PRB2XORCompactQtree(std::vector<Point<uint> > &points, BitSequenceBuilder *bs, BitSequenceBuilder *bb,BitSequenceBuilder *bc, XorCodeBuilder *xorbuid, int k1=2, int k2=2, int F=1, int max_level_k1=0, int max_levels_ki=0);
    ...
    PRB2XORCompactQtree(ifstream & f) {
...
//    }
    ...
    void create(const std::vector<Point<uint> > &vp,
                BitSequenceBuilder *bs, BitSequenceBuilder *bb, BitSequenceBuilder *bc, XorCodeBuilder *xorbuid);
    ...
    XorCode ***leaves_; //encoded path for each leaf (per level)
