	...
	class CodeTest : public ::testing::Test {
		protected:
			virtual void SetUp() {
				...
				q[0]=0; q[1]=0; q[2]=2; q[3]=14;
				vp4_.push_back(q);

				q[0]=0; q[1]=0; q[2]=15; q[3]=16;
				vp4_.push_back(q);

				q[0]=0; q[1]=0; q[2]=17; q[3]=18;
				vp4_.push_back(q);

				q[0]=0; q[1]=15; q[2]=0; q[3]=1;
				vp4_.push_back(q);

				q[0]=15; q[1]=0; q[2]=0; q[3]=15;
				vp4_.push_back(q);

				q[0]=15; q[1]=1; q[2]=0; q[3]=15;
				vp4_.push_back(q);

				q[0]=15; q[1]=2; q[2]=5; q[3]=20;
				vp4_.push_back(q);
