...
namespace {
	...
	class PRWTest : public ::testing::Test {
		protected:
			virtual void SetUp() {
		  ...
		  void AllPointsTester(int k1=2, int k2=2, int max_level_k1=0, int max_level_ki=0) {
		      printf("checking k1=%d k2=%d lk1=%d lki=%d\n",k1,k2,max_level_k1,max_level_ki);
		  	PRWCompactQtree a(vp_, new BitSequenceBuilderRG(20),new BitSequenceBuilderRG(20),k1,k2,max_level_k1,max_level_ki);
		  ...
		  void LoadSave(int k1=2, int k2=2, int max_level_k1=0, int max_level_ki=0) {
		    PRWCompactQtree a(vp_, new BitSequenceBuilderRG(20),new BitSequenceBuilderRG(20),k1,k2,max_level_k1,max_level_ki);
	...
	TEST_F(PRWTest, AllPointsSimple) {
		AllPointsTester(2,2,0,0);
	}
	
	TEST_F(PRWTest, K1Equals4) {
	    int k1=4;
	    int k2=2;
    ...
    TEST_F(PRWTest, LoadSaveBasic) {
        LoadSave();
    }

    TEST_F(PRWTest, LoadSaveAllMods) {
        int k1=4;
        int k2=2;
        Point<uint> pmax_dim(max(vp_));
        uint maxval;
